...
//
//  //batch get
////  def batchGet(connection: Connection, tablename: String, family: String, columns: List[String], rowKeys: List[String]): Unit = {
////    var table: Table = null
////        try {
////          val userTable = TableName.valueOf(tablename)
////          table = connection.getTable(userTable)
////          val batch = Set(1,2,3)
////          //process many rowKyes
////          rowKeys.foreach(rowKey => {
////            val get = new Get(rowKey.getBytes())
////            //process many columns
...
//
//  //batch get
//  def batchGet(connection: Connection, tablename: String, family: String, columns: List[String], rows: List[String]): Unit = {
//    var table: Table = null
//    try {
//
//    } finally {
